...
urlpatterns = [
    ...
    path('hauptview/0/sessionexecutor/',views.sessionexecutor, name = 'sessionexecutor'),
    path('hauptview/1/sessionexecutor/',views.sessionexecutor, name = 'sessionexecutor'),
    path('hauptview/0/sessionexecutor/session_executor_apply/',views.session_executor_apply, name = 'session_executor_apply'),
